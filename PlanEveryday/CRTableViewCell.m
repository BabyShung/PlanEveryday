...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        //hao added
        self.detailLabeltop = [[UILabel alloc] initWithFrame:CGRectMake(kMarkCell, -30, self.frame.size.width - kMarkCell, self.frame.size.height)];
        self.detailLabeltop.textColor = [UIColor blackColor];
        self.detailLabeltop.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleHeight;
        self.detailLabeltop.textAlignment = NSTextAlignmentLeft;
        self.detailLabeltop.backgroundColor = [UIColor clearColor];
        [self.contentView addSubview:self.detailLabeltop];
        
        //hao added
        self.detailLabelbottom = [[UILabel alloc] initWithFrame:CGRectMake(kMarkCell, 30, self.frame.size.width - kMarkCell, self.frame.size.height)];
        self.detailLabelbottom.textColor = [UIColor blackColor];
        self.detailLabelbottom.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleHeight;
        self.detailLabelbottom.textAlignment = NSTextAlignmentLeft;
        self.detailLabelbottom.backgroundColor = [UIColor clearColor];
        [self.contentView addSubview:self.detailLabelbottom];
