...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) 
    {
        ...
        // backgound--------------------------
        UIImageView *bacground = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"PickerBG200.png"]];
        ...
        // shadows
        UIImageView *shadows = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"PickerShadow200.png"]];
        [self addSubview:shadows];
        
        // glass
        UIImage *glassImage = [UIImage imageNamed:@"PickerGlass200.png"];
